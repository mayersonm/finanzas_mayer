...
function cmdInsightsIA(chatId) {
  ...
  const prompt = [
    ...
    'El primer insight debe mencionar Caja actual registrada con su monto.',
    '',
    resumen,
    '',
    'Formato:',
    ...
    '',
    '1. [insight de caja actual con numero real]',
...
function resumenFinancieroParaIA_(chatId) {
  ...
  if (d1 && d1.ok) {
    ...
    return [
      ...
      '- El ciclo contable es 22-22; las transacciones conservan su fecha real.',
