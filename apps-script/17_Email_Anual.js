...
function construirHtmlAnualEmail_(data) {
  ...
  return [
    ...
    cardEmail_('Ingresos', fmtEmail_(data.totals.ingresos), '#16a34a'),
    cardEmail_('Gastos', fmtEmail_(data.totals.gastos), '#dc2626'),
    cardEmail_('Balance', fmtSignedEmail_(balance), colorBalance),
    cardEmail_('Meses negativos', String(monthsNegative), monthsNegative > 0 ? '#dc2626' : '#16a34a'),
    '</div>',
