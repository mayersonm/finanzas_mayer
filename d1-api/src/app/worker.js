...
import { investmentsList } from '../modules/investments/service.js';
...
export default {
  async fetch(request, env) {
    ...
    try {
      ...
      const investmentsResponse = await investmentsRoutes(request, env, url);
      if (investmentsResponse) return investmentsResponse;
