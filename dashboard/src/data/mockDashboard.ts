...
export const MOCK_DASHBOARD: DashboardData = {
  ...
  cierreAutomatico: {
    ...
    message: 'Faltan 18 dias para el cierre 22/06.',
    closeDate: '2026-06-22',
    daysToClose: 18,
    targetCycleKey: '2026-05',
    targetCycleStart: '2026-05-22',
    targetCycleEnd: '2026-06-22',
    targetCycleRange: '22/05/2026 - 22/06/2026',
    suggestedSavings: 400,
  ...
  dineroLibre: {
    status: 'healthy',
    statusLabel: 'Plan sano',
    closeDate: '2026-06-22',
    closeLabel: 'Cierre 22/06',
    daysLeft: 24,
    income: 6500,
    spent: 1270,
    baseBalance: 5230,
    ...
    savingsTarget: 2000,
    actualSavings: 2000,
    configuredSavingsGoal: 400,
    savingsConfigured: true,
    recommendedSavings: 400,
    emergencyBuffer: 0,
    budgetLimit: 1150,
    budgetRemaining: 200,
    variableReserve: 200,
    freeAfterCommitments: 930,
    availableToSpend: 200,
    ...
    actions: ['Mantente en modo seguro unos dias para proteger el cierre.'],
  },
  objetivoSemanal: {
    status: 'ok',
    ...
    dailyRemaining: 7.66,
    progressPct: 34,
    message: 'Puedes gastar hasta S/ 7.66 por dia esta semana.',
  },
  calendario: {
    monthKey: '2026-06',
    label: 'Junio',
    ...
    cycleStart: '2026-05-22',
    cycleEnd: '2026-06-22',
    cycleClose: '2026-06-22',
    cycleRange: '22/05/2026 - 22/06/2026',
    events: [
      { id: 'objetivo:2026-06-07', date: '2026-06-07', type: 'objetivo', title: 'Objetivo semanal', description: 'Puedes gastar hasta S/ 7.66 por dia esta semana.', amount: 38.31, currency: 'PEN', priority: 'normal' },
      { id: 'credito:2026-06-10', date: '2026-06-10', type: 'credito', title: 'Credito: Metro', description: 'Pago de tarjeta', amount: 135, currency: 'PEN', priority: 'normal' },
      { id: 'fijo:2026-06-22', date: '2026-06-22', type: 'fijo', title: 'Fijo pendiente: Alquiler', description: 'Servicios', amount: 1500, currency: 'PEN', priority: 'medium' },
      { id: 'cierre:2026-06-22', date: '2026-06-22', type: 'cierre', title: 'Cierre 22/06', description: 'Cerrar ciclo, separar ahorro sugerido y reiniciar presupuesto.', priority: 'high' },
